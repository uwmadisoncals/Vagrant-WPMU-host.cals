...
function widget($args, $instance) {
   ...
   echo $before_widget;
   // Display the widget
   echo '<div><h4 class="twitterHeader">Twitter<a href=""><img src="'.get_stylesheet_directory_uri().'/images/Twitter_logo_white.png" alt="twitter icon"></a></h4></div><div id="twitFetch"></div>';
   echo '<div>';
