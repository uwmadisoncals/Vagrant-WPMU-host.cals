...
<div class="mobileScroll">
  ...
  <?php if (function_exists( 'muneeb_ssp_slider')) {muneeb_ssp_slider( 351 );} ?>
   </div>
...
<!--  <div class="collegeFeature">
  	<ul class="slides">
  		<li class="flipin">
  			<img src="<?php echo get_stylesheet_directory_uri(); ?>/images/homefeature/feature_img1.jpg" alt="College Feature">
  			<div class="featureCaption">
  				<h2>Welcome to the Agronomy Department</h2>
  				<a href="#">Our Mission</a>
  			</div>
  			
  		</li>
  		<li class="flipin">
  			<img src="<?php echo get_stylesheet_directory_uri(); ?>/images/homefeature/anifeature_img2.jpg" alt="College Feature">
  			<div class="featureCaption">
  				<h2>Who We Are</h2>
...
?>
			...
			<div class="homeLeftStatic">
    	 <div class="newsItemNonPreload customize padding">
			
			
			
			<?php 
$page_id = 364; // 123 should be replaced with a specific Page's id from your site, which you can find by mousing over the link to edit that Page on the Manage Pages admin page. The id will be embedded in the query string of the URL, e.g. page.php?action=edit&post=123.
...
?>
			...
			<div class="newsItemNonPreload customize">
			    <?php if (function_exists( 'muneeb_ssp_slider')) {muneeb_ssp_slider( 362 );} ?>
...
<?php get_sidebar(); ?>
<!--<div class="collegeFeature2 marginbottom">
  <?php if (function_exists( 'muneeb_ssp_slider')) {muneeb_ssp_slider( 353 );} ?>
   </div>-->
<?php get_footer(); ?>