<!-- Daniel, this page is used in the following, "the dairyccap team","contact",'resources', 'news', 'events' . 
	It is basically everything except the main page(as accesed by cowclick) -->
<?php get_header(); ?>
