...
<div class="mobileScroll">
  ...
  <?php if (function_exists( 'muneeb_ssp_slider')) {muneeb_ssp_slider( 270 );} ?>
   </div>
  ...
  <!--<div class="collegeFeature">
  	<ul class="slides">
  		...
  		<li class="flipin">
  			<img src="<?php echo get_stylesheet_directory_uri(); ?>/images/homefeature/feature_img2.jpg" alt="College Feature">
  			<div class="featureCaption">
  		...
  		<li class="flipin">
  			<img src="<?php echo get_stylesheet_directory_uri(); ?>/images/homefeature/feature_img3.jpg" alt="College Feature">
  			<div class="featureCaption">
  				<h2>Events</h2>
  		...
  		<li class="flipin">
  			<img src="<?php echo get_stylesheet_directory_uri(); ?>/images/homefeature/feature_img4.jpg" alt="College Feature">
  			<div class="featureCaption">
  				<h2>Contact</h2>
