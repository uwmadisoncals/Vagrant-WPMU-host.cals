...
function twentyeleven_setup() {
	...
	register_nav_menu( 'utility', __( 'Utility Menu', 'twentyeleven' ) );
	...
	$custom_header_support = array(
		...
		'width' => apply_filters( 'twentyeleven_header_image_width', 383 ),
	...
	if ( ! function_exists( 'get_custom_header' ) ) {
		...
		define( 'HEADER_IMAGE', '%s/images/headers/library_logo.png' );
	...
	register_default_headers( array(
		'primary' => array(
			'url' => '%s/images/headers/library_logo.png',
			'thumbnail_url' => '%s/images/headers/library_logo.png',
