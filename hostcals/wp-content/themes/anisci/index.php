...
<div class="mobileScroll">
  ...
  <div class="collegeFeature">
  	<ul class="slides">
  		<li class="flipin">
  			<img src="<?php echo get_stylesheet_directory_uri(); ?>/images/homefeature/anifeature_img1.jpg" alt="College Feature">
  			<div class="featureCaption">
  				<h2>Animal Sciences</h2>
  		...
  		<li class="flipin">
  			...
  			<div class="featureCaption">
  				<h2>Immunology & Cellular Biology</h2>
  		...
  		<li class="flipin">
  			<img src="<?php echo get_stylesheet_directory_uri(); ?>/images/homefeature/anifeature_img3.jpg" alt="College Feature">
  			<div class="featureCaption">
  				<h2>Microscopy</h2>
  				
  				<a href="http://www.ansci.wisc.edu/BBPIC/">Discover More</a>
  			</div>
  			
  		</li>
  		<li class="flipin">
  			<img src="<?php echo get_stylesheet_directory_uri(); ?>/images/homefeature/anifeature_img4.jpg" alt="College Feature">
  			<div class="featureCaption">
  				<h2 class="thin sans">Department News and Information</h2>
  				
  				<a href="#">Learn about what else is happening in Animal Sciences</a>
  			</div>
