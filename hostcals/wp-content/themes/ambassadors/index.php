...
<div class="mobileScroll">
  ...
  <div class="collegeFeature">
  	<ul class="slides">
  		<li class="flipin">
  			<img src="<?php echo get_stylesheet_directory_uri(); ?>/images/homefeature/ambassador_cover1.jpg" alt="CALS Ambassadors">
  			<div class="featureCaption">
  				<h2>CALS<br/>Ambassadors</h2>  				
  				<a href="/ambassadors/our-ambassadors/">Meet the Ambassadors</a>
  			</div>
