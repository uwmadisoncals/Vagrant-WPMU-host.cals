...
<div class="mobileScroll">
  ...
  <div class="collegeFeature">
  	<ul class="slides">
  		<li class="flipin">
  			<img src="<?php echo get_stylesheet_directory_uri(); ?>/images/homefeature/expandingglobalclassroom2.jpg" alt="Expanding the Global Classroom">
  			<div class="featureCaption">
  				<h2>Expanding the Global Classroom</h2>
  				<a href="http://grow.cals.wisc.edu/featured/expanding-the-global-classroom">Read about these teaching projects in the summer issue of Grow</a>
  			</div> 			
  		</li>
        
  		<li class="flipin">
  			<img src="<?php echo get_stylesheet_directory_uri(); ?>/images/homefeature/studyabroad2.jpg" alt="CALS International Programs">
  			<div class="featureCaption">
  				<h2>CALS International Programs</h2>  				
  				<a href="http://ip.cals.wisc.edu/">Study, intern, and research abroad through CALS IP</a>
  			</div>  			
  		</li>

  		<li class="flipin">
  			<img src="<?php echo get_stylesheet_directory_uri(); ?>/images/homefeature/engagefaculty2.jpg" alt="Teaching Innovations at UW-Madison">
  			<div class="featureCaption">
  				<h2>Teaching Innovations at UW-Madison</h2>  				
  				<a href="http://www.nxtbook.com/nxtbooks/naylor/IIEB0112/index.php#/30">Engaging faculty in science internationalization</a>
  			</div>  			
  		</li>
			...
			<div class = 'sliderContainer'>
				...
				<div class = 'iosSlider'>
					...
					<div class = 'slider'>
						...
						<!-- Mobile Slides will be built automatically from primary slides -->
