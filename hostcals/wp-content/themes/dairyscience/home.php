...
<?php query_posts("category_name=news&posts_per_page=3&offset=1"); ?>
<?php if (have_posts()) : ?>
  <?php while (have_posts()) : the_post();  ?>
					...
					<div class="span-33">
						<div class="box dropin2 doubleHeight">
                                           ...
                                           <?php if (class_exists('EM_Events')) {
											    ...
											    echo EM_Events::output( array('limit'=>2,'orderby'=>'event_start_date','sort'=>'ASC') );
							...
							<div class="bottomShade"></div>	
								<!-- .spotlight_slide -->  
                       <a href="<?php get_site_url(); ?>/dairyscience/calendar-2/" class="moreButton">Events Calendar</a>
