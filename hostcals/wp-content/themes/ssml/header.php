...
<div id="page" class="hfeed mobileOff">
	<header id="branding" role="banner">
			<hgroup class="heading">
				<h1 id="site-title"><span><a href="<?php echo esc_url( home_url( '/' ) ); ?>" title="<?php echo esc_attr( get_bloginfo( 'name', 'display' ) ); ?>" rel="home"><?php bloginfo( 'name' ); ?></a></span></h1>
				<h2 id="site-description"><?php bloginfo( 'description' ); ?></h2>
			<img src="<?php echo get_stylesheet_directory_uri(); ?>/images/header.jpg" alt="Header Image" style="margin-bottom:1px;">
			<?php
			...
			?>
				<div class="globalSearch" style="display:none;"><!-- BSK added display:none; to hide search box -->
				<?php get_search_form(); ?>
