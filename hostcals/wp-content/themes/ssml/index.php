...
<div class="mobileScroll">
  ...
  <div class="collegeFeature mobileShown">
  	<ul class="slides">
  		<li class="flipin">
  			<img src="<?php echo get_stylesheet_directory_uri(); ?>/images/homefeature/slider_1.jpg" alt="Feature Image">
  			<div class="featureCaption">
  				<h2>Sustainable Soil Management Lab</h2>
  		...
  		<li class="flipin">
  			<img src="<?php echo get_stylesheet_directory_uri(); ?>/images/homefeature/slider_2.jpg" alt="Feature Image">
  			<div class="featureCaption">
  		...
  		<li class="flipin">
  			<img src="<?php echo get_stylesheet_directory_uri(); ?>/images/homefeature/slider_3.jpg" alt="Feature Image">
  			<div class="featureCaption">
  		...
  		<li class="flipin">
  			<img src="<?php echo get_stylesheet_directory_uri(); ?>/images/homefeature/slider_4.jpg" alt="Feature Image">
  			<div class="featureCaption">
  				<!--<h2>In the lab. In the field. <em class="green sans thin">By your side</em>.</h2>
