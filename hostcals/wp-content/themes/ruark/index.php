...
<div class="mobileScroll">
  ...
  <div class="collegeFeature mobileShown">
  	<ul class="slides">
  		<li class="flipin">
  			<img src="<?php echo get_stylesheet_directory_uri(); ?>/images/homefeature/extension.jpg" alt="Feature Image">
  			<div class="featureCaption">
  				<h2>Nutrient Cycling and Agroecosystems Lab</h2>
  		...
  		<li class="flipin">
  			<img src="<?php echo get_stylesheet_directory_uri(); ?>/images/homefeature/radish.jpg" alt="Feature Image">
  			<div class="featureCaption">
  		...
  		<li class="flipin">
  			<img src="<?php echo get_stylesheet_directory_uri(); ?>/images/homefeature/sidedress.jpg" alt="Feature Image">
  			<div class="featureCaption">
